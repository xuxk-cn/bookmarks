// 樱花飘落背景（WebGL Shader）
import { createShaderRunner } from '/js/shader-runner.js';

const SHADER = `#define DRAG_MULT 0.38 // changes how much waves pull on the water
...
export function start(canvas) {
  runner = createShaderRunner(canvas, SHADER);
  runner?.start();
}
